            ...
            <div className="about-content flex flex-col gap-6">
              ...
              <ul className="flex flex-col gap-3">
                {[
                  ...
                  "Выполнение практик для более глубокого контакта с собой и своим состоянием",
                ...
                <Button
                  onClick={() => {
                    if (!consentOffer || !consentPd) {
                      ...
                      window.open("https://t.me/unpackingusova_bot?start=c1778634486289-ds", "_blank", "noopener,noreferrer")
                    }
                  }}
          ...
          <div className="mx-auto max-w-5xl">
            <div className="cta-box flex flex-col items-center gap-6 rounded-[20px] bg-gradient-to-r from-[#8B6914] to-[#C9A84C] p-6 md:flex-row md:gap-8 md:p-12 lg:p-16">
              ...
              <div className="flex w-full flex-col gap-3 md:w-auto">
                <Button asChild className="h-auto w-full rounded-xl bg-[#0E0E0E] px-4 py-3 text-sm leading-snug text-white hover:bg-[#0E0E0E]/90 md:w-auto md:px-8 md:text-lg">
                  <a href="https://t.me/m/PE2d8pn0NTgy" target="_blank" rel="noopener noreferrer">Записаться в личные сообщения</a>
                </Button>
